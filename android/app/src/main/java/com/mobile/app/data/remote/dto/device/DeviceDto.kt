...
data class DeviceDto(
    ...
    @SerializedName("latestCondition") val latestCondition: DeviceConditionDto? = null,
    @SerializedName("latestInspection") val latestInspection: DeviceInspectionDto? = null
)
